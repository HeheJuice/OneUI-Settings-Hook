                ...
                object : XC_MethodHook() {
                    override fun afterHookedMethod(param: MethodHookParam) {
                        try {
                            ...
                            // Mod Name / Summary item updated to launch module SettingsActivity on tap
                            ...
                            val nameIntent = Intent().apply {
                                setClassName("com.HeheJuice.OneUISettingsHook", "com.HeheJuice.OneUISettingsHook.SettingsActivity")
